...
const POINTS = [
  "1M+ tasvir himoyalangan",
  "99.2% deepfake aniqlash aniqligi",
  "Huquqiy kuchga ega elektron dalillar",
  "OneID bilan rasmiy identifikatsiya",
];
      ...
      <div className="relative hidden overflow-hidden bg-ink-900 lg:block">
        ...
        <div className="relative flex h-full flex-col justify-between p-16">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-4 py-2 text-sm font-medium text-white backdrop-blur">
            ...
            Tasvir huquqlari himoyasi platformasi
          </div>
          <div>
            <h2 className="text-4xl font-bold leading-tight text-white">
              Tasviringiz. <br />
              <span className="text-brand-300">Huquqingiz.</span> Himoyangiz.
            </h2>
          ...
          <p className="text-sm text-white/40">
            © 2026 ImageRights.uz — Markaziy Osiyodagi birinchi tasvir huquqlari
            ekotizimi.
          </p>
        </div>
      </div>
